...
namespace LeagueLib
{
    public class Items
    {
        ...
        private static readonly Item[] pre_items =
        {
            ...
            new Item(
                3007, "Archangel's Staff (Crystal Scar)", Tier.Legendary, 1120, 1890, 0f, new List<int> { 3070, 1026 }),
            ...
            new Item(
                3254, "Berserker's Greaves - Enchantment: Alacrity", Tier.Enchantment, 475, 0, 0f,
                new List<int> { 3006 }),
            new Item(
                3251, "Berserker's Greaves - Enchantment: Captain", Tier.Enchantment, 600, 0, 0f, new List<int> { 3006 }),
            new Item(
                3253, "Berserker's Greaves - Enchantment: Distortion", Tier.Enchantment, 475, 0, 0f,
                new List<int> { 3006 }),
            new Item(
                3252, "Berserker's Greaves - Enchantment: Furor", Tier.Enchantment, 475, 0, 0f, new List<int> { 3006 }),
            new Item(
                3250, "Berserker's Greaves - Enchantment: Homeguard", Tier.Enchantment, 475, 0, 0f,
                new List<int> { 3006 }),
            ...
            new Item(
                3153, "Blade of the Ruined King", Tier.Mythical, 900, 2240, 450f, new List<int> { 3144, 1042, 1042 }),
            ...
            new Item(
                3274, "Boots of Mobility - Enchantment: Alacrity", Tier.Enchantment, 475, 0, 0f, new List<int> { 3117 }),
            new Item(
                3271, "Boots of Mobility - Enchantment: Captain", Tier.Enchantment, 600, 0, 0f, new List<int> { 3117 }),
            new Item(
                3273, "Boots of Mobility - Enchantment: Distortion", Tier.Enchantment, 475, 0, 0f,
                new List<int> { 3117 }),
            new Item(
                3272, "Boots of Mobility - Enchantment: Furor", Tier.Enchantment, 475, 0, 0f, new List<int> { 3117 }),
            new Item(
                3270, "Boots of Mobility - Enchantment: Homeguard", Tier.Enchantment, 475, 0, 0f, new List<int> { 3117 }),
            ...
            new Item(
                3284, "Boots of Swiftness - Enchantment: Alacrity", Tier.Enchantment, 475, 0, 0f, new List<int> { 3009 }),
            new Item(
                3281, "Boots of Swiftness - Enchantment: Captain", Tier.Enchantment, 600, 0, 0f, new List<int> { 3009 }),
            new Item(
                3283, "Boots of Swiftness - Enchantment: Distortion", Tier.Enchantment, 475, 0, 0f,
                new List<int> { 3009 }),
            new Item(
                3282, "Boots of Swiftness - Enchantment: Furor", Tier.Enchantment, 475, 0, 0f, new List<int> { 3009 }),
            new Item(
                3280, "Boots of Swiftness - Enchantment: Homeguard", Tier.Enchantment, 475, 0, 0f,
                new List<int> { 3009 }),
        ...
        internal static readonly IEnumerable<Item> IEpre_items = pre_items;
        private static readonly List<Item> items = new List<Item>(IEpre_items);
