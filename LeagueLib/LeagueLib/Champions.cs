...
namespace LeagueLib
{
    ...
    {
        #region champsData
        private static Tuple<int, string, string, string, string, Tuple<int, int, int, int>>[] champions = 
        {
        ...
        #region GetData
        public static void GetData(int cDataID, out int champID, out string champName, out string champDesc, out string roleA, out string roleB, out int attackPower, out int defensePower, out int abilityPower, out int difficultyPower)
        {
        ...
        public static void GetChampionStats(int cDataID, out int attackPower, out int defensePower, out int abilityPower, out int difficultyPower)
        {
            if (cDataID < champions.Length)
            {
                attackPower = champions[cDataID].Item6.Item1;
