...
namespace Karma
{
    ...
    internal class Damages
    {
        ...
        private static double GetQDamage(Obj_AI_Base target, bool mantra, bool explodeOnly)
        {
            ...
            var explosionDamage = new[] { 50, 150, 250, 350 }[Instances.Spells[SpellSlot.Q].Level - 1];
            var bonusDamage = new[] { 25, 75, 125, 175 }[Instances.Spells[SpellSlot.Q].Level - 1];
        ...
        private static double GetWDamage(Obj_AI_Base target, bool mantra)
        {
            ...
            var bonusDamage = new[] { 75, 150, 225, 300 }[Instances.Spells[SpellSlot.W].Level - 1];
